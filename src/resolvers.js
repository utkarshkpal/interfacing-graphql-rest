...
module.exports = {
    Query: {
        launches: async(_, {
            ...
            const allLaunches = await dataSources
                .launchAPI
                .getAllLaunches();
    ...
    Launch: {
        isBooked: async(launch, _, {dataSources}) => dataSources
            .userAPI
            .isBookedOnLaunch({launchId: launch.id})
    },
    User: {
        trips: async(_, __, {dataSources}) => {
            // get ids of launches by user
            const launchIds = await dataSources
                .userAPI
                .getLaunchIdsByUser();
    ...
    Mutation: {
        ...
        bookTrips: async(_, {
            ...
            const results = await dataSources
                .userAPI
                .bookTrips({launchIds});
            const launches = await dataSources
                .launchAPI
        ...
        cancelTrip: async(_, {
            ...
            const launch = await dataSources
                .launchAPI
